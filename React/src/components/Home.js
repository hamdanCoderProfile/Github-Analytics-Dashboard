      ...
      <Box component="main" sx={{ flexGrow: 1, p: 3 }}>
        ...
        {loading ? (
          ...
          <div>
            ...
            {/* Rendering Timeseries Forecasting of branch using Tensorflow and
                Keras LSTM  */}
            {flag && (
              <div>
                <Divider
                ...
                <div>
                  <Typography component="h4">Model Loss for branch</Typography>
                  {/* Render the model loss image Commits  */}
                  <img
                    src={githubRepoData?.commitsImageUrls?.model_loss_image_url}
                    alt={"Model Loss for Commits"}
                ...
                <div>
                  <Typography component="h4">
                    LSTM Generated Data for branch
                  </Typography>
                  {/* Render the LSTM generated image Commits */}
                  <img
                    src={
            ...
            {flag && (
              <div>
                ...
                />
                <Typography variant="h5" component="div" gutterBottom>
                  Timeseries Forecasting of releases using Tensorflow and Keras
                  LSTM based on past month
                </Typography>
            ...
            {flag && (
              <div>
                ...
                />
                <Typography variant="h5" component="div" gutterBottom>
                  Timeseries Forecasting of branch using Facebook/Prophet based
                  on past months
                </Typography>

                <div>
                  <Typography component="h4">Forecast of branch</Typography>
                  {/* Render the model loss image Commits  */}
                  <img
                    src={
                      githubRepoData?.fb_commitsImageUrls
            ...
            {flag && (
              <div>
                ...
                <div>
                  <Typography component="h4">Forecast of releases</Typography>
                  {/* Render the model loss image Commits  */}
                  <img
                    src={
                      githubRepoData?.fb_commitsImageUrls
                ...
                <div>
                  <Typography component="h4">
                    Forecast Components of release
                  </Typography>
                  {/* Render the LSTM generated image Commits */}
                  <img
                    src={
            ...
            {flag && (
              <div>
                ...
                <div>
                  <Typography component="h4">
                    Forecast Components of contributor
                  </Typography>
                  {/* Render the LSTM generated image Commits */}
                  <img
                    src={
            ...
            {flag && (
              <div>
                ...
                />
                <Typography variant="h5" component="div" gutterBottom>
                  Timeseries Forecasting of branch Issues using StatsModel based
                  on past months
                </Typography>

                <div>
                  <Typography component="h4">
                    Observation Graph of branch Issues
                  </Typography>
                  {/* Render the model loss image Commits  */}
                  <img
                    src={
                ...
                <div>
                  <Typography component="h4">
                    Time Series Forecasting of branch Issues
                  </Typography>
                  {/* Render the LSTM generated image Closed At */}
                  <img
                    src={
            ...
            {flag && (
              <div>
                ...
                />
                <Typography variant="h5" component="div" gutterBottom>
                  Timeseries Forecasting of contributor Issues using StatsModel
                  based on past months
                </Typography>

                <div>
                  <Typography component="h4">
                    Observation Graph of contributor
                  </Typography>
                  {/* Render the model loss image Commits  */}
                  <img
                    src={
                ...
                <div>
                  <Typography component="h4">
                    Time Series Forecasting of contributor
                  </Typography>
                  {/* Render the LSTM generated image Closed At */}
                  <img
                    src={
            ...
            {flag && (
              <div>
                ...
                />
                <Typography variant="h5" component="div" gutterBottom>
                  Timeseries Forecasting of releases using StatsModel based on
                  past months
                </Typography>

                <div>
                  <Typography component="h4">
                    Observation Graph of releases
                  </Typography>
                  {/* Render the model loss image Commits  */}
                  <img
                    src={
                ...
                <div>
                  <Typography component="h4">
                    Time Series Forecasting of release
                  </Typography>
                  {/* Render the LSTM generated image Closed At */}
                  <img
                    src={
